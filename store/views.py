...
def register_user(request):
  ...
  if request.method == 'POST':
    ...
    if form.is_valid():
      ...
      messages.success(request, 'You have been registered successfully! Please fill in your user info...')
...
def search(request):
  if request.method == 'POST':
    ...
    if not searched:
      messages.success(request, "Sorry...This product doesn't exist! Try again")
